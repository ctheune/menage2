...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["recipe_id"],
            ["recipes.id"],
            name=op.f("fk_recipe_weekdays_recipe_id_recipes"),
        ),
        sa.PrimaryKeyConstraint(
            "recipe_id", "weekday", name=op.f("pk_recipe_weekdays")
        ),
    )
    op.create_table(
        "recipes_seasons",
        ...
        sa.ForeignKeyConstraint(
            ["recipe_id"],
            ["recipes.id"],
            name=op.f("fk_recipes_seasons_recipe_id_recipes"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["recipe_id"], ["recipes.id"], name=op.f("fk_schedules_recipe_id_recipes")
        ),
